...
##### ----- Parameters ----- #####
READPATH = '/Users/qinghuahan/Desktop/LiuLabProjects/3D_Vessel_Segmentation/VesselSeg/largevessels/largest_region.tif' # filepath of the vessel mask after segmentation
SAVEPATH = '/Users/qinghuahan/Desktop/LiuLabProjects/3D_Vessel_Segmentation/VesselSeg/largevessels/' # filepath where the masks for each feature are saved
##################################
...
imsave(SAVEPATH + 'largest_region_centerlines.tif', centerlines)
